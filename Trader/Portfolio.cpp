...
std::vector<std::string> Portfolio::get_ids() const
{
    std::map<const std::string,Holding*>::const_iterator it = _Portfolio.begin();
    std::vector<std::string> id_vec;
    
    for(; it != _Portfolio.end(); it++)
    {
