#ifndef _CkOmaDrm_W_H
#define _CkOmaDrm_W_H
#include "Chilkat_C.h"
...
BOOL CkOmaDrmW_GetHeaderField(HCkOmaDrmW cHandle, const wchar_t *fieldName, HCkStringW fieldVal);
...
BOOL CkOmaDrmW_SaveLastError(HCkOmaDrmW cHandle, const wchar_t *filename);
