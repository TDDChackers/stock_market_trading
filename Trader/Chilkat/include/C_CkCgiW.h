...
void CkCgiW_getDebugLogFilename(HCkCgiW cHandle, HCkStringW retval);
void CkCgiW_putDebugLogFilename(HCkCgiW cHandle, const wchar_t *newVal);
...
void CkCgiW_GetRawPostData(HCkCgiW cHandle, HCkByteDataW outData);
...
BOOL CkCgiW_SaveLastError(HCkCgiW cHandle, const wchar_t *filename);
