...
HCkZipEntryW CkZipW_AppendBase64(HCkZipW cHandle, const wchar_t *fileName, const wchar_t *data);
HCkZipEntryW CkZipW_AppendCompressed(HCkZipW cHandle, const wchar_t *fileName, HCkByteDataW data);
HCkZipEntryW CkZipW_AppendData(HCkZipW cHandle, const wchar_t *fileName, HCkByteDataW data);
HCkZipEntryW CkZipW_AppendData2(HCkZipW cHandle, const wchar_t *fileName, const wchar_t *data, unsigned long dataLen);
...
HCkZipEntryW CkZipW_AppendHex(HCkZipW cHandle, const wchar_t *fileName, const wchar_t *data);
...
BOOL CkZipW_AppendOneFileOrDir(HCkZipW cHandle, const wchar_t *fileOrDirName, BOOL saveExtraPath);
HCkZipEntryW CkZipW_AppendString(HCkZipW cHandle, const wchar_t *fileName, const wchar_t *str);
HCkZipEntryW CkZipW_AppendString2(HCkZipW cHandle, const wchar_t *fileName, const wchar_t *str, const wchar_t *charset);
...
#if defined(WIN32) && !defined(__MINGW32__)
#if defined(WIN32) && !defined(WINCE)
void CkZipW_GetExeConfigParam(HCkZipW cHandle, const wchar_t *name, HCkStringW outStr);
#endif
#endif
HCkZipEntryW CkZipW_InsertNew(HCkZipW cHandle, const wchar_t *fileName, long beforeIndex);
...
BOOL CkZipW_NewZip(HCkZipW cHandle, const wchar_t *zipFileName);
#if defined(WIN32) && !defined(__MINGW32__)
#if defined(WIN32) && !defined(WINCE)
...
BOOL CkZipW_OpenFromMemory(HCkZipW cHandle, const unsigned char *zipFileInMemory, unsigned long dataLen);
...
#endif
#endif
BOOL CkZipW_SaveLastError(HCkZipW cHandle, const wchar_t *filename);
...
#if defined(WIN32) && !defined(__MINGW32__)
#if defined(WIN32) && !defined(WINCE)
BOOL CkZipW_WriteExe(HCkZipW cHandle, const wchar_t *filename);
#endif
#endif
#if defined(WIN32) && !defined(__MINGW32__)
#if defined(WIN32) && !defined(WINCE)
BOOL CkZipW_WriteExe2(HCkZipW cHandle, const wchar_t *exeFilename, const wchar_t *outExeFilename, BOOL bAesEncrypt, int keyLength, const wchar_t *password);
#endif
#endif
#if defined(WIN32) && !defined(__MINGW32__)
#if defined(WIN32) && !defined(WINCE)
