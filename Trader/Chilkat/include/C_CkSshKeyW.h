#ifndef _CkSshKey_W_H
#define _CkSshKey_W_H
#include "Chilkat_C.h"
...
BOOL CkSshKeyW_LoadText(HCkSshKeyW cHandle, const wchar_t *filename, HCkStringW outStr);
BOOL CkSshKeyW_SaveLastError(HCkSshKeyW cHandle, const wchar_t *filename);
...
const wchar_t *CkSshKeyW__loadText(HCkSshKeyW cHandle, const wchar_t *filename);
