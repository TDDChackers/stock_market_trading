...
bool BytesToString(CkByteData &inData,const wchar_t *w1,CkString &outStr);
...
void Decode(const wchar_t *w1,const wchar_t *w2,CkByteData &outData);
...
bool EncodeBytes(const void *byteData,int numBytes,const wchar_t *w1,CkString &outStr);
...
void GenerateSecretKey(const wchar_t *w1,CkByteData &outData);
...
void HmacString(const wchar_t *w1,CkByteData &outHmac);
...
void SetEncryptCert(const CkCertW *cert);
void SetEncryptCert(const CkCertW &cert);
...
bool WriteFile(const wchar_t *w1,CkByteData &fileData);
const wchar_t *bytesToString(CkByteData &inData,const wchar_t *w1);
...
const wchar_t *encodeBytes(const void *byteData,int numBytes,const wchar_t *w1);
