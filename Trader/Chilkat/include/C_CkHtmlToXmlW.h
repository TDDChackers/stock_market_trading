#ifndef _CkHtmlToXml_W_H
#define _CkHtmlToXml_W_H
#include "Chilkat_C.h"
...
BOOL CkHtmlToXmlW_ConvertFile(HCkHtmlToXmlW cHandle, const wchar_t *inHtmlFilename, const wchar_t *outXmlFilename);
...
BOOL CkHtmlToXmlW_ReadFileToString(HCkHtmlToXmlW cHandle, const wchar_t *filename, const wchar_t *srcCharset, HCkStringW outStr);
BOOL CkHtmlToXmlW_SaveLastError(HCkHtmlToXmlW cHandle, const wchar_t *filename);
...
BOOL CkHtmlToXmlW_WriteStringToFile(HCkHtmlToXmlW cHandle, const wchar_t *str, const wchar_t *filename, const wchar_t *charset);
...
const wchar_t *CkHtmlToXmlW__readFileToString(HCkHtmlToXmlW cHandle, const wchar_t *filename, const wchar_t *srcCharset);
