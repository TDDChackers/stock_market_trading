...
CkZipEntryW *AppendData2(const wchar_t *w1,const wchar_t *w2,unsigned long dataLen);
bool AppendFiles(const wchar_t *w1,bool recurse,CkZipProgress *progress);
bool AppendFilesEx(const wchar_t *w1,bool recurse,bool saveExtraPath,bool archiveOnly,bool includeHidden,bool includeSystem,CkZipProgress *progress);
CkZipEntryW *AppendHex(const wchar_t *w1,const wchar_t *w2);
bool AppendMultiple(const CkStringArrayW &fileSpecs,bool recurse,CkZipProgress *progress);
...
void CloseZip(void);
bool DeleteEntry(const CkZipEntryW &entry);
void ExcludeDir(const wchar_t *w1);
bool Extract(const wchar_t *w1,CkZipProgress *progress);
bool ExtractInto(const wchar_t *w1);
bool ExtractMatching(const wchar_t *w1,const wchar_t *w2,CkZipProgress *progress);
bool ExtractNewer(const wchar_t *w1,CkZipProgress *progress);
...
#if defined(WIN32) && !defined(WINCE)
void GetExeConfigParam(const wchar_t *w1,CkString &outStr);
#endif
...
bool OpenFromWeb(const wchar_t *w1,CkZipProgress *progress);
#if defined(WIN32) && !defined(WINCE)
bool OpenMyEmbedded(const wchar_t *w1);
#endif
bool OpenZip(const wchar_t *w1,CkZipProgress *progress);
...
int Unzip(const wchar_t *w1,CkZipProgress *progress);
int UnzipInto(const wchar_t *w1,CkZipProgress *progress);
int UnzipMatching(const wchar_t *w1,const wchar_t *w2,bool verbose,CkZipProgress *progress);
int UnzipMatchingInto(const wchar_t *w1,const wchar_t *w2,bool verbose,CkZipProgress *progress);
int UnzipNewer(const wchar_t *w1,CkZipProgress *progress);
bool VerifyPassword(void);
#if defined(WIN32) && !defined(WINCE)
bool WriteExe(const wchar_t *w1,CkZipProgress *progress);
#endif
#if defined(WIN32) && !defined(WINCE)
bool WriteExe2(const wchar_t *w1,const wchar_t *w2,bool bAesEncrypt,int keyLength,const wchar_t *w3,CkZipProgress *progress);
#endif
#if defined(WIN32) && !defined(WINCE)
