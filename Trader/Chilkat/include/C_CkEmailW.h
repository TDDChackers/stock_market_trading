...
BOOL CkEmailW_AddDataAttachment(HCkEmailW cHandle, const wchar_t *fileName, const unsigned char *data, unsigned long dataLen);
...
BOOL CkEmailW_AddFileAttachment(HCkEmailW cHandle, const wchar_t *fileName, HCkStringW outStrContentType);
BOOL CkEmailW_AddFileAttachment2(HCkEmailW cHandle, const wchar_t *fileName, const wchar_t *contentType);
...
void CkEmailW_AddRelatedData2P(HCkEmailW cHandle, const unsigned char *data, unsigned long dataLen, const wchar_t *fileNameInHtml);
BOOL CkEmailW_AddRelatedDataP(HCkEmailW cHandle, const wchar_t *nameInHtml, const unsigned char *data, unsigned long dataLen, HCkStringW outStrContentId);
BOOL CkEmailW_AddRelatedFile(HCkEmailW cHandle, const wchar_t *fileName, HCkStringW outStrContentID);
...
BOOL CkEmailW_BEncodeBytes(HCkEmailW cHandle, const unsigned char *data, unsigned long dataLen, const wchar_t *charset, HCkStringW outEncodedStr);
...
BOOL CkEmailW_CreateTempMht(HCkEmailW cHandle, const wchar_t *inFilename, HCkStringW outTempMhtFilenameInOut);
...
BOOL CkEmailW_GetFileContent(HCkEmailW cHandle, const wchar_t *filename, HCkByteDataW outData);
...
BOOL CkEmailW_LoadEml(HCkEmailW cHandle, const wchar_t *mimeFilename);
BOOL CkEmailW_LoadXml(HCkEmailW cHandle, const wchar_t *xmlFilename);
BOOL CkEmailW_LoadXmlString(HCkEmailW cHandle, const wchar_t *xmlStr);
BOOL CkEmailW_QEncodeBytes(HCkEmailW cHandle, const unsigned char *data, unsigned long dataLen, const wchar_t *charset, HCkStringW outEncodedStr);
...
BOOL CkEmailW_SaveEml(HCkEmailW cHandle, const wchar_t *filename);
BOOL CkEmailW_SaveLastError(HCkEmailW cHandle, const wchar_t *filename);
BOOL CkEmailW_SaveRelatedItem(HCkEmailW cHandle, long index, const wchar_t *directory);
BOOL CkEmailW_SaveXml(HCkEmailW cHandle, const wchar_t *filename);
...
BOOL CkEmailW_SetFromMimeText2(HCkEmailW cHandle, const wchar_t *mimeText, int numBytes);
...
BOOL CkEmailW_SetMbHtmlBody(HCkEmailW cHandle, const wchar_t *charset, const unsigned char *data, unsigned long dataLen);
BOOL CkEmailW_SetMbPlainTextBody(HCkEmailW cHandle, const wchar_t *charset, const unsigned char *data, unsigned long dataLen);
...
const wchar_t *CkEmailW__addFileAttachment(HCkEmailW cHandle, const wchar_t *fileName);
const wchar_t *CkEmailW__addRelatedData(HCkEmailW cHandle, const wchar_t *fileName, HCkByteDataW inData);
const wchar_t *CkEmailW__addRelatedDataP(HCkEmailW cHandle, const wchar_t *nameInHtml, const unsigned char *data, unsigned long dataLen);
const wchar_t *CkEmailW__addRelatedFile(HCkEmailW cHandle, const wchar_t *fileName);
...
const wchar_t *CkEmailW__bEncodeBytes(HCkEmailW cHandle, const unsigned char *data, unsigned long dataLen, const wchar_t *charset);
...
const wchar_t *CkEmailW__createTempMht(HCkEmailW cHandle, const wchar_t *inFilename);
...
const wchar_t *CkEmailW__qEncodeBytes(HCkEmailW cHandle, const unsigned char *data, unsigned long dataLen, const wchar_t *charset);
