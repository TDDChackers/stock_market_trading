...
class CkHttpRequestW : public CkWideCharBase
{
	...
	CkHttpRequestW(CkHttpRequest *p) : m_impl(p)
	    {
...
bool AddBytesForUpload(const wchar_t *w1,const wchar_t *w2,CkByteData &byteData);
bool AddBytesForUpload2(const wchar_t *w1,const wchar_t *w2,CkByteData &byteData,const wchar_t *w3);
