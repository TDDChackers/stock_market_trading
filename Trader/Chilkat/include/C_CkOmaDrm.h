...
BOOL CkOmaDrm_GetHeaderField(HCkOmaDrm cHandle, const char *fieldName, HCkString fieldVal);
...
BOOL CkOmaDrm_SaveLastError(HCkOmaDrm cHandle, const char *filename);
