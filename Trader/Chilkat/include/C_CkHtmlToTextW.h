#ifndef _CkHtmlToText_W_H
#define _CkHtmlToText_W_H
#include "Chilkat_C.h"
...
BOOL CkHtmlToTextW_ReadFileToString(HCkHtmlToTextW cHandle, const wchar_t *filename, const wchar_t *srcCharset, HCkStringW outStr);
BOOL CkHtmlToTextW_SaveLastError(HCkHtmlToTextW cHandle, const wchar_t *filename);
...
BOOL CkHtmlToTextW_WriteStringToFile(HCkHtmlToTextW cHandle, const wchar_t *str, const wchar_t *filename, const wchar_t *charset);
...
const wchar_t *CkHtmlToTextW__readFileToString(HCkHtmlToTextW cHandle, const wchar_t *filename, const wchar_t *srcCharset);
