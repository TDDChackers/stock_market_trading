...
BOOL CkXmp_GetArray(HCkXmp cHandle, HCkXml xml, const char *propName, HCkStringArray sa);
...
BOOL CkXmp_GetStructPropNames(HCkXmp cHandle, HCkXml xml, const char *structName, HCkStringArray sa);
