...
bool PostBinary(const wchar_t *w1,CkByteData &byteData,const wchar_t *w2,bool md5,bool gzip,CkString &outStr);
...
bool PutBinary(const wchar_t *w1,CkByteData &byteData,const wchar_t *w2,bool md5,bool gzip,CkString &outStr);
...
bool S3_UploadBytes(CkByteData &objectContent,const wchar_t *w1,const wchar_t *w2,const wchar_t *w3);
...
bool SetSslClientCertPfx(const wchar_t *w1,const wchar_t *w2,const wchar_t *w3);
...
const wchar_t *postBinary(const wchar_t *w1,CkByteData &byteData,const wchar_t *w2,bool md5,bool gzip);
...
const wchar_t *putBinary(const wchar_t *w1,CkByteData &byteData,const wchar_t *w2,bool md5,bool gzip);
