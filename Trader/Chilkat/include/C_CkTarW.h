...
BOOL CkTarW_ListXml(HCkTarW cHandle, const wchar_t *tarFilename, HCkStringW outStr);
BOOL CkTarW_SaveLastError(HCkTarW cHandle, const wchar_t *filename);
BOOL CkTarW_UnlockComponent(HCkTarW cHandle, const wchar_t *unlockCode);
int CkTarW_Untar(HCkTarW cHandle, const wchar_t *tarFilename);
BOOL CkTarW_UntarBz2(HCkTarW cHandle, const wchar_t *tarFilename);
...
BOOL CkTarW_UntarGz(HCkTarW cHandle, const wchar_t *tarFilename);
BOOL CkTarW_UntarZ(HCkTarW cHandle, const wchar_t *tarFilename);
BOOL CkTarW_VerifyTar(HCkTarW cHandle, const wchar_t *tarFilename);
BOOL CkTarW_WriteTar(HCkTarW cHandle, const wchar_t *tarFilename);
BOOL CkTarW_WriteTarBz2(HCkTarW cHandle, const wchar_t *outFilename);
BOOL CkTarW_WriteTarGz(HCkTarW cHandle, const wchar_t *outFilename);
...
const wchar_t *CkTarW__listXml(HCkTarW cHandle, const wchar_t *tarFilename);
