...
bool SaveToCache(const wchar_t *w1,SYSTEMTIME &expire,const wchar_t *w2,CkByteData &data);
bool SaveToCacheDt(const wchar_t *w1,CkDateTimeW &expire,const wchar_t *w2,CkByteData &data);
bool SaveToCacheNoExpire(const wchar_t *w1,const wchar_t *w2,CkByteData &data);
