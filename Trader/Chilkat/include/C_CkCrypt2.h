...
void CkCrypt2_Decode(HCkCrypt2 cHandle, const char *str, const char *encoding, HCkByteData outData);
...
BOOL CkCrypt2_EncodeBytes(HCkCrypt2 cHandle, const void *byteData, int numBytes, const char *encoding, HCkString outStr);
...
void CkCrypt2_GenerateSecretKey(HCkCrypt2 cHandle, const char *password, HCkByteData outData);
...
void CkCrypt2_HmacBytes(HCkCrypt2 cHandle, HCkByteData inBytes, HCkByteData outHmac);
BOOL CkCrypt2_HmacBytesENC(HCkCrypt2 cHandle, HCkByteData inBytes, HCkString outEncodedHmac);
void CkCrypt2_HmacString(HCkCrypt2 cHandle, const char *inText, HCkByteData outHmac);
...
const char *CkCrypt2_encodeBytes(HCkCrypt2 cHandle, const void *byteData, int numBytes, const char *encoding);
