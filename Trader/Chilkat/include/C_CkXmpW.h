...
long CkXmpW_getNumEmbedded(HCkXmpW cHandle);
...
BOOL CkXmpW_GetArray(HCkXmpW cHandle, HCkXmlW xml, const wchar_t *propName, HCkStringArrayW sa);
...
BOOL CkXmpW_GetStructPropNames(HCkXmpW cHandle, HCkXmlW xml, const wchar_t *structName, HCkStringArrayW sa);
...
void CkXmpW_NewXmp(HCkXmpW cHandle, HCkXmlW xmlOut);
...
BOOL CkXmpW_SaveLastError(HCkXmpW cHandle, const wchar_t *filename);
BOOL CkXmpW_SaveToBuffer(HCkXmpW cHandle, HCkByteDataW byteData);
