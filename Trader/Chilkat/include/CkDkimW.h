...
bool LoadDkimPkBytes(CkByteData &privateKeyDer,const wchar_t *w1);
bool LoadDkimPkFile(const wchar_t *w1,const wchar_t *w2);
bool LoadDomainKeyPk(const wchar_t *w1,const wchar_t *w2);
bool LoadDomainKeyPkBytes(CkByteData &privateKeyDer,const wchar_t *w1);
