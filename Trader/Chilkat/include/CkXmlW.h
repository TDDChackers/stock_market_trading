...
bool GetBinaryContent(CkByteData &data,bool unzipFlag,bool decryptFlag,const wchar_t *w1);
...
bool GetChildIntValue(const wchar_t *w1,int &value);
...
bool SetBinaryContent2(const unsigned char *data,unsigned long dataLen,bool zipFlag,bool encryptFlag,const wchar_t *w1);
bool SetBinaryContentFromFile(const wchar_t *w1,bool zipFlag,bool encryptFlag,const wchar_t *w2);
void SortByAttribute(const wchar_t *w1,long ascending);
void SortByAttributeInt(const wchar_t *w1,bool ascending);
void SortByContent(long ascending);
void SortByTag(long ascending);
void SortRecordsByAttribute(const wchar_t *w1,const wchar_t *w2,long ascending);
void SortRecordsByContent(const wchar_t *w1,long ascending);
