...
BOOL CkCertW_ExportCertDerFile(HCkCertW cHandle, const wchar_t *filename);
BOOL CkCertW_ExportCertPem(HCkCertW cHandle, HCkStringW outStr);
BOOL CkCertW_ExportCertPemFile(HCkCertW cHandle, const wchar_t *filename);
...
#if defined(WIN32) && !defined(__MINGW32__)
BOOL CkCertW_ExportToPfxFile(HCkCertW cHandle, const wchar_t *pfxFilename, const wchar_t *password, BOOL bIncludeChain);
#endif
#endif
...
BOOL CkCertW_LoadFromBinary(HCkCertW cHandle, const unsigned char *buf, unsigned long bufLen);
BOOL CkCertW_LoadFromFile(HCkCertW cHandle, const wchar_t *filename);
BOOL CkCertW_LoadPfxData(HCkCertW cHandle, HCkByteDataW pfxData, const wchar_t *password);
BOOL CkCertW_LoadPfxData2(HCkCertW cHandle, const unsigned char *buf, unsigned long bufLen, const wchar_t *password);
BOOL CkCertW_LoadPfxFile(HCkCertW cHandle, const wchar_t *filename, const wchar_t *password);
BOOL CkCertW_PemFileToDerFile(HCkCertW cHandle, const wchar_t *inFilename, const wchar_t *outFilename);
BOOL CkCertW_SaveLastError(HCkCertW cHandle, const wchar_t *filename);
BOOL CkCertW_SaveToFile(HCkCertW cHandle, const wchar_t *filename);
