#ifndef _CkCompression_W_H
#define _CkCompression_W_H
#include "Chilkat_C.h"
...
BOOL CkCompressionW_CompressFile(HCkCompressionW cHandle, const wchar_t *inFile, const wchar_t *outFile);
...
BOOL CkCompressionW_DecompressFile(HCkCompressionW cHandle, const wchar_t *inFile, const wchar_t *outFile);
...
BOOL CkCompressionW_SaveLastError(HCkCompressionW cHandle, const wchar_t *filename);
