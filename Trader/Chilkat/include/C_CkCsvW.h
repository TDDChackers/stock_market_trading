...
BOOL CkCsvW_LoadFile(HCkCsvW cHandle, const wchar_t *filename);
...
BOOL CkCsvW_SaveFile(HCkCsvW cHandle, const wchar_t *filename);
BOOL CkCsvW_SaveFile2(HCkCsvW cHandle, const wchar_t *filename, const wchar_t *charset);
BOOL CkCsvW_SaveLastError(HCkCsvW cHandle, const wchar_t *filename);
