...
BOOL CkCsv_LoadFile(HCkCsv cHandle, const char *filename);
...
BOOL CkCsv_SaveFile(HCkCsv cHandle, const char *filename);
BOOL CkCsv_SaveFile2(HCkCsv cHandle, const char *filename, const char *charset);
BOOL CkCsv_SaveLastError(HCkCsv cHandle, const char *filename);
