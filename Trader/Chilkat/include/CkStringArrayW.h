...
class CkStringArrayW : public CkWideCharBase
{
	...
	CkStringArrayW(CkStringArray *p) : m_impl(p)
	    {
...
const wchar_t *getString(long index);
...
const wchar_t *strAt(long index);
