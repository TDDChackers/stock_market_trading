...
unsigned long GetFileSize32(const wchar_t *w1,bool bFollowLinks,bool bIsHandle);
...
bool WriteFileBytes(const wchar_t *w1,CkByteData &data);
bool WriteFileBytes32(const wchar_t *w1,int offset,CkByteData &data);
bool WriteFileBytes64(const wchar_t *w1,__int64 offset64,CkByteData &data);
bool WriteFileBytes64s(const wchar_t *w1,const wchar_t *w2,CkByteData &data);
