...
void CkSshW_GetReceivedData(HCkSshW cHandle, int channelNum, HCkByteDataW outBytes);
...
void CkSshW_GetReceivedStderr(HCkSshW cHandle, int channelNum, HCkByteDataW outBytes);
...
BOOL CkSshW_SaveLastError(HCkSshW cHandle, const wchar_t *filename);
