...
bool AddDataAttachment(const wchar_t *w1,const unsigned char *data,unsigned long dataLen);
bool AddDataAttachment2(const wchar_t *w1,CkByteData &content,const wchar_t *w2);
bool AddEncryptCert(CkCertW &cert);
bool AddFileAttachment(const wchar_t *w1,CkString *strContentType);
...
bool AddPfxSourceData(CkByteData &pfxData,const wchar_t *w1);
bool AddPfxSourceFile(const wchar_t *w1,const wchar_t *w2);
bool AddPlainTextAlternativeBody(const wchar_t *w1);
bool AddRelatedData(const wchar_t *w1,CkByteData &inData,CkString &outStr);
void AddRelatedData2(CkByteData &inData,const wchar_t *w1);
void AddRelatedData2P(const unsigned char *data,unsigned long dataLen,const wchar_t *w1);
bool AddRelatedDataP(const wchar_t *w1,const unsigned char *data,unsigned long dataLen,CkString *strContentId);
bool AddRelatedDataP(const wchar_t *w1,const unsigned char *data,unsigned long dataLen,CkString &outStrContentId);
bool AddRelatedFile(const wchar_t *w1,CkString *strContentID);
...
bool AddRelatedString(const wchar_t *w1,const wchar_t *w2,const wchar_t *w3,CkString *cid);
...
bool BEncodeBytes(const unsigned char *data,unsigned long dataLen,const wchar_t *w1,CkString &outEncodedStr);
...
bool CreateTempMht(const wchar_t *w1,CkString &outTempMhtFilenameInOut);
...
bool QEncodeBytes(const unsigned char *data,unsigned long dataLen,const wchar_t *w1,CkString &outEncodedStr);
...
bool SetFromMimeBytes2(CkByteData &mimeBytes,const wchar_t *w1);
bool SetFromMimeObject(CkMimeW &mime);
bool SetFromMimeText(const wchar_t *w1);
bool SetFromMimeText2(const wchar_t *w1,int numBytes);
bool SetFromXmlText(const wchar_t *w1);
void SetHtmlBody(const wchar_t *w1);
bool SetMbHtmlBody(const wchar_t *w1,const unsigned char *data,unsigned long dataLen);
bool SetMbPlainTextBody(const wchar_t *w1,const unsigned char *data,unsigned long dataLen);
...
const wchar_t *addRelatedData(const wchar_t *w1,CkByteData &inData);
const wchar_t *addRelatedDataP(const wchar_t *w1,const unsigned char *data,unsigned long dataLen);
...
const wchar_t *bEncodeBytes(const unsigned char *data,unsigned long dataLen,const wchar_t *w1);
...
const wchar_t *qEncodeBytes(const unsigned char *data,unsigned long dataLen,const wchar_t *w1);
