...
bool SignHash(CkByteData &hashBytes,const wchar_t *w1,CkByteData &outBytes);
...
bool VerifyHash(CkByteData &hashBytes,const wchar_t *w1,CkByteData &sigBytes);
