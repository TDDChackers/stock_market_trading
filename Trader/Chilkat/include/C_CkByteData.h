...
void CkByteData_append2(HCkByteData cHandle, const void *byteData, unsigned long numBytes);
...
BOOL CkByteData_appendFile(HCkByteData cHandle, const char *filename);
BOOL CkByteData_appendFileW(HCkByteData cHandle, const wchar_t *filename);
...
BOOL CkByteData_beginsWith2(HCkByteData cHandle, const void *byteData, unsigned long byteDataLen);
void CkByteData_borrowData(HCkByteData cHandle, void *yourData, unsigned long numBytes);
void CkByteData_byteSwap4321(HCkByteData cHandle);
void CkByteData_clear(HCkByteData cHandle);
const char *CkByteData_computeHash(HCkByteData cHandle, const char *hashAlg, const char *outputEncoding);
...
BOOL CkByteData_equals2(HCkByteData cHandle, const void *data, unsigned long numBytes);
int CkByteData_findBytes(HCkByteData cHandle, HCkByteData byteData);
int CkByteData_findBytes2(HCkByteData cHandle, const void *byteData, unsigned long byteDataLen);
...
BOOL CkByteData_loadFile(HCkByteData cHandle, const char *filename);
BOOL CkByteData_loadFileW(HCkByteData cHandle, const wchar_t *filename);
...
BOOL CkByteData_saveFile(HCkByteData cHandle, const char *filename);
BOOL CkByteData_saveFileW(HCkByteData cHandle, const wchar_t *filename);
