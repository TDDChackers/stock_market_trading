#ifndef _CkHttpRequest_W_H
#define _CkHttpRequest_W_H
#include "Chilkat_C.h"
...
BOOL CkHttpRequestW_AddFileForUpload(HCkHttpRequestW cHandle, const wchar_t *name, const wchar_t *filename);
BOOL CkHttpRequestW_AddFileForUpload2(HCkHttpRequestW cHandle, const wchar_t *name, const wchar_t *filename, const wchar_t *contentType);
...
BOOL CkHttpRequestW_LoadBodyFromFile(HCkHttpRequestW cHandle, const wchar_t *filename);
...
BOOL CkHttpRequestW_SaveLastError(HCkHttpRequestW cHandle, const wchar_t *filename);
void CkHttpRequestW_SetFromUrl(HCkHttpRequestW cHandle, const wchar_t *url);
BOOL CkHttpRequestW_StreamBodyFromFile(HCkHttpRequestW cHandle, const wchar_t *filename);
